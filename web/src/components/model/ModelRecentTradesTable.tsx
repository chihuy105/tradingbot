...
export default function ModelRecentTradesTable({
  modelId,
}: {
  modelId: string;
}) {
    ...
    <div>
      ...
      <div className="overflow-x-auto" style={{ overflowY: "visible" }}>
        <table className="w-full text-left text-[12px] terminal-text">
          <thead
            className="ui-sans sticky top-0 z-10"
            style={{
              ...
              rows.map((t, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-1.5 pr-3">
                      {holdHM(t.entry_time, t.exit_time)}
                    </td>
                    <td className="py-1.5 pr-3 tabular-nums">
                      {fmtUSD(notionalIn)}
                    </td>
                    ...
                    <td className="py-1.5 pr-3 tabular-nums">
                      {fmtUSD(t.total_commission_dollars)}
                    </td>
                    <td
